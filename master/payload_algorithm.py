import numpy as np
from Pymavlink_movement import deploy_payload
...
def release_payload(v, altitude, R, x, y, target_lat, target_long, release_point_lat, release_point_long):
    # if p_long ~ release_point_long and p_lat ~ release_point_lat, release payload
    ...
    if np.linalg.norm(r) < R:
        print("RELEASE POINT IS NOT ON THE PATH")
        deploy_payload(v, -1, release_point_lat, release_point_long, altitude)
