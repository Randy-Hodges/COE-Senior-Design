...
# Function to delete CSV of previous mission callbacks
def delete_csv():
...
# Create or append new CSV entries for upcoming mission callbacks
    ...
    while True:
        ...
        if msg.get_type() in ('ATTITUDE', 'VFR_HUD', 'GLOBAL_POSITION_INT', 'WIND','HEARTBEAT'):
            ...
            with open('mission_callbacks/mission_callbacks.csv', 'a', newline='') as csvfile:
                ...
                new_entry = [time.time()-start, yaw, pitch, roll, ground_speed, air_speed, latitude, altitude, longitude, wind_direction, wind_speed, system_status]
